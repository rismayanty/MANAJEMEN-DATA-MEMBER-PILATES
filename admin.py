...
from operasi import data_member, hitung_member, opsi_paket, biaya_pilates
...
def menu_admin(pilates_shain):
    ...
    if pilih == "1":
        try:
            ...
            jadwal = input("JADWAL PILATES (Senin, 08:00-16:00): ")
            input("JADWAL PILATES (Senin, 08:00-16.00): ")
            input("JADWAL PILATES (Senin, 08:00-16.00): ")
            input("JADWAL PILATES (Senin, 08:00-16.00): ")
            input("JADWAL PILATES (Senin, 08:00-16.00): ")
        ...
        if sub == "1":
            ...
            for id_m, data in pilates_shain.items():
                ...
                table.add_row([
                    id_m, data["nama"], data["paket"],
                    data["durasi"], biaya, data["jadwal"]
                ])
